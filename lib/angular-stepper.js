...
.directive('rnStepper', function() {
    return {
        ...
        template: '<button class="btn btn-info btn-sm btn-raised" type="button" ng-disabled="isOverMin() || ngDisabled" ng-click="decrement()"><i class="fa fa-minus"></i></button>' +
                  '<input type="text" ng-model="ngModel" ng-disabled="ngDisabled" class="form-control input-md">' +
                  '<button class="btn btn-info btn-sm btn-raised" type="button" ng-disabled="isOverMax() || ngDisabled" ng-click="increment()"><i class="fa fa-plus"></i></button>',
